...
export default function HomePage() {
  ...
  return (
    <>
      <DynamicSEO
        title="EJAUIPAR - European Journal of Ayurvedic, Unani and Interdisciplinary Pharmaceuticals & Allopathic Review"
        description="A peer-reviewed international journal dedicated to publishing rigorous research in Ayurvedic, Unani, and pharmaceutical sciences."
        keywords={['Ayurvedic medicine', 'Unani medicine', 'pharmaceuticals', 'research journal', 'academic publishing', 'EJAUIPAR', 'peer review']}
        ogImage="https://ejauipar.com/og-image.jpg"
        canonicalUrl="https://ejauipar.com"
      />
      <WebsiteSchema
        name="EJAUIPAR"
        url="https://ejauipar.com"
        description="A peer-reviewed international journal dedicated to publishing rigorous research in Ayurvedic, Unani, and pharmaceutical sciences."
        publisher="EJAUIPAR"
      />
      <OrganizationSchema
        name="EJAUIPAR"
        url="https://ejauipar.com"
        logo="https://ejauipar.com/ejauipar-logo.svg"
        description="EJAUIPAR - European Journal of Ayurvedic, Unani and Interdisciplinary Pharmaceuticals & Allopathic Review"
        contactPoint={{
          email: "editor@ejauipar.com",
      ...
      <div className="min-h-screen font-sans">
        ...
        {/* Hero Section */}
        <section className="relative border-b border-slate-200" style={{background: 'linear-gradient(135deg, #7a4a1a 0%, #a8622a 100%)'}}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              <div className="lg:col-span-8 space-y-6">
                <div className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold tracking-wide uppercase" style={{background: 'rgba(255,255,255,0.15)', color: '#f4d4a8'}}>
                  ISSN: 3143-0503 (Online)
                </div>
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold leading-tight text-white">
                  ...
                  <span style={{color: '#f4d4a8'}}>Ayurvedic, Unani and<br className="hidden md:block" />Pharmaceutical Sciences</span>
                </h1>

                <p className="text-xl max-w-2xl leading-relaxed" style={{color: '#f0d9b8'}}>
                  A peer-reviewed international journal dedicated to publishing rigorous research in Ayurvedic, Unani, and pharmaceutical sciences globally.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <Link
                    ...
                    style={{background: '#d4832b'}}
                    onMouseEnter={e => (e.currentTarget.style.background='#b86d1f')}
                    onMouseLeave={e => (e.currentTarget.style.background='#d4832b')}
                  >
                    Submit Manuscript
                ...
                <div className="grid grid-cols-3 gap-8 pt-8 max-w-lg" style={{borderTop: '1px solid rgba(255,255,255,0.2)'}}>
                  <div>
                    ...
                    <div className="text-sm font-medium" style={{color: '#f4d4a8'}}>Research Articles</div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-white">{stats.totalAuthors.toLocaleString()}+</div>
                    <div className="text-sm font-medium" style={{color: '#f4d4a8'}}>Global Contributors</div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-white">17+</div>
                    <div className="text-sm font-medium" style={{color: '#f4d4a8'}}>Indexed In</div>
                  </div>
                </div>
              </div>
        ...
        {/* Why Choose Us */}
        <section className="py-16 border-y border-slate-200" style={{background: '#fdf8f3'}}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-serif font-bold mb-4" style={{color: '#7a4a1a'}}>Journal Features</h2>
              <p className="text-slate-600 max-w-2xl mx-auto">
                We are committed to the highest standards of academic publishing in Ayurvedic and pharmaceutical sciences.
              </p>
            </div>

            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {[
                { icon: Globe, title: 'Global Reach', desc: 'Connecting Ayurvedic and pharmaceutical researchers from over 70 countries.' },
                ...
                { icon: BookOpen, title: 'Open Access', desc: 'Free unrestricted access to all published Ayurvedic and pharmaceutical research.' },
                ...
                <div key={index} className="bg-white rounded-lg p-6 shadow-sm" style={{border: '1px solid #e8d4a8', borderTop: '3px solid #d4832b'}}>
                  <feature.icon className="w-8 h-8 mb-4" style={{color: '#7a4a1a'}} />
                  <h3 className="text-lg font-bold mb-2" style={{color: '#7a4a1a'}}>{feature.title}</h3>
        ...
        {/* CTA */}
        <section className="py-16 text-white" style={{background: 'linear-gradient(135deg, #7a4a1a 0%, #a8622a 100%)'}}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl md:text-4xl font-serif font-bold mb-6 text-white">
              Submit Your Ayurvedic & Pharmaceutical Research Today
            </h2>
            <p className="mb-8 text-lg" style={{color: '#f0d9b8'}}>
              Join our community of Ayurvedic and pharmaceutical scholars and contribute to advancing holistic medicine globally.
            </p>
